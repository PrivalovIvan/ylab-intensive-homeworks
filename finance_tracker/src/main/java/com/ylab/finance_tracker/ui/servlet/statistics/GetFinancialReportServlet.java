...
@WebServlet("/statistics/report")
public class GetFinancialReportServlet extends HttpServlet {
    private final StatisticsService statisticsService;
    private final ObjectMapper objectMapper;

    public GetFinancialReportServlet() throws Exception {
        this(
    ...
    public GetFinancialReportServlet(StatisticsService statisticsService, ObjectMapper objectMapper) {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            writer.write(objectMapper.writeValueAsString(statisticsService.getExpensesByCategory(user.getEmail(), fromDate, toDate)));
