...
class GetFinancialReportServletTest {
    ...
    void setUp() throws Exception {
        ...
        servlet = new GetFinancialReportServlet(statisticsService, objectMapper);
    ...
    @Test
    void testDoGet_ValidDates_ReturnsFinancialReport() throws Exception {
        ...
        verify(statisticsService).getExpensesByCategory(mockUser.getEmail(), fromDate, toDate);
    ...
    void testDoGet_SQLException_ReturnsInternalServerError() throws Exception {
        ...
        when(request.getParameter("from")).thenReturn(from);
        when(request.getParameter("to")).thenReturn(to);
        when(statisticsService.getExpensesByCategory(mockUser.getEmail(), fromDate, toDate))
